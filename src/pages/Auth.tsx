...
const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background">
      <motion.div
        className="pointer-events-none absolute right-0 top-0 hidden h-screen w-1/2 items-center justify-center overflow-hidden lg:flex"
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 hidden h-1/3 w-1/2 bg-gradient-to-t from-background via-background/50 to-transparent lg:block" />
      <div className="pointer-events-none absolute bottom-0 right-0 hidden h-4/5 w-1/2 bg-gradient-to-t from-background via-background/50 to-transparent lg:block" />

      <div className="absolute top-1/2 z-0 hidden -translate-y-1/2 lg:block" style={{ left: '-8rem' }}>
        <div
          style={{
      ...
      <div className="relative z-20 flex min-h-screen items-center justify-center px-4">
        ...
        <motion.div
          ...
          className="w-full max-w-md px-0 sm:px-0"
